...
class Atendimento():
    def __init__(self, data: date, horario_inicio: time, horario_fim: time, tipo_atendimento: str, valor: float, clinica: Clinica, paciente: Paciente, profissional: Profissional):
        self.__data = data
